...
Search and retrieve local documents via Gety CLI — connect your AI coding agent to your local files, documents, and knowledge base.
...
- Enable AI integrations in Gety desktop app settings
